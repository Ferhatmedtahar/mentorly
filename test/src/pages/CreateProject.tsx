    ...
    <>
      ...
      <div className="container py-10">
        ...
        <form onSubmit={handleSubmit} className="startup-form">
          ...
          <div>
            <label htmlFor="longDescription" className="startup-form-label">
              Detailed Description
            </label>
            <textarea
              id="longDescription"
            ...
            {errors.longDescription && (
              <p className="startup-form-error">{errors.longDescription}</p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3 mt-3">
              {collaborationTypes.map((type) => (
                <Button
                  ...
                  type="button"
                  variant={
                    formData.collaborationType === type ? "default" : "outline"
                  }
                  className={
            ...
            {errors.collaborationType && (
              <p className="startup-form-error">{errors.collaborationType}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.timeline && (
              <p className="startup-form-error">{errors.timeline}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.teamSize && (
              <p className="startup-form-error">{errors.teamSize}</p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              {skillOptions.map((skill) => (
                <Badge
                  key={skill}
                  variant={
                    formData.skills.includes(skill) ? "default" : "secondary"
                  }
            ...
            {errors.skills && (
              <p className="startup-form-error">{errors.skills}</p>
            )}
          </div>
